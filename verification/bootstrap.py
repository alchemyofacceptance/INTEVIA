...
def gate(run_root):
    ...
    _check_required(summary, "coordinator summary (summary.json)", ["run_id", "result", "exit_status", "execution", "identity"],
    ...
    _check_required(summary.get("identity", {}) if isinstance(summary.get("identity"), dict) else {}, "coordinator summary identity record (summary.json identity)", ["commit"],
